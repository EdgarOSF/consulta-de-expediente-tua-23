...
from report.utils import create_base_report_template
...
def edit(request, report_type):
    ...
    *create_album_report_template* for this Demo App. Normally you'd probably
    ...
    return render(request, 'webpage/edit.html', context)
    ...
    if request.method == 'PUT':
        ...
        try:
            ...
            ReportRequest.objects.create(
                key=key, report_definition=json.dumps(report_definition, default=''),
                data=json.dumps(data, default=''), is_test_data=is_test_data,
